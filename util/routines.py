...
class Aerial():
    ...
    def run(self, agent):
        ...
        delta_x = agent.ball.location - xf
        ...
        if delta_x.magnitude() > 50:
            ...
            if self.target != None:
                ...
                defaultPD(agent, agent.me.local(
                    self.ball_location - agent.me.location))
    ...
    def is_viable(self, car, time):
        ...
        required_acc = (2 * delta_x.normalize(True)
                        [1]) / ((T - tau1) * (T - tau1))
