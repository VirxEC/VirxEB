...
class EnemyPrediction:
    ...
    def add_agent(self, agent):
        try:
            ...
            print(
                f"VirxEB ({ agent.me.index }): Enemy prediction is lagging behind...")
            self.queue.join()
...
class BallPrediction:
    ...
    def main(self, q):
        while True:
            ...
            if len(agent.foes) == 1 or agent.ball_to_goal < 5120:
    ...
    def add_agent(self, agent):
        try:
            ...
            print(
                f"VirxEB ({ agent.me.index }): Ball prediction is lagging behind...")
            self.queue.join()
            print(f"VirxEB ({agent.me.index}): All caught up! Here I go!")
...
class TeammatePrediction:
    ...
    def add_agent(self, agent):
        try:
            ...
            print(
                f"VirxEB ({ agent.me.index }): Teammate prediction is lagging behind...")
            self.queue.join()
            print(f"VirxEB ({agent.me.index}): All caught up! Here I go!")
